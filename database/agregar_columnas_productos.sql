-- ============================================================
--  Vortex Epix - Columnas + imágenes (INSTALACIÓN NUEVA)
--  Si YA agregaste las columnas antes, NO ejecutes el paso 1;
--  usa solo "actualizar_imagenes.sql".
-- ============================================================

-- PASO 1: columnas nuevas (solo una vez)
ALTER TABLE `productos`
  ADD COLUMN `imagen` VARCHAR(255) NULL AFTER `codigo_barras`,
  ADD COLUMN `stock_minimo` INT NOT NULL DEFAULT 20 AFTER `imagen`,
  ADD COLUMN `stock_maximo` INT NOT NULL DEFAULT 100 AFTER `stock_minimo`;
