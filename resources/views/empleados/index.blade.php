    ...
    <div class="bg-white rounded-xl w-full max-w-2xl shadow-xl max-h-[92vh] overflow-y-auto">
        ...
        <form id="formEmp" method="POST" action="{{ route('empleados.store') }}" class="p-5">
            ...
            <div class="grid grid-cols-2 gap-4">
                ...
                <div><label class="block text-xs font-medium text-slate-600 mb-1">Teléfono</label><input type="text" name="telefono" id="e_telefono" class="w-full border border-slate-200 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-vortex-green/40"></div>
